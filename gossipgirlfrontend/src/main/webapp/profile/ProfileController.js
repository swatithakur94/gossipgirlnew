    ...
    function($scope,$filter,$ProfileService,$location,$window,$routeParams,$fileUpload){
		...
		$ProfileService
				...
				.then(
						function(response) {
							...
							$scope.userdetails.Image = 'http://localhost:9080/gossipgirlbackend/resources/images/'
		...
		$scope.setFile = function(element) {
			...
			console.log('file is :');
			console.dir(file);
			var uploadUrl = "http://localhost:9080/gossipgirlbackend/updateProfilePicture/";
